  ...
  <h3 className="text-[20px] text-[#303F58] font-bold ms-1">Add New Internal Stock</h3>
   ...
   <div className="container mx-auto p-4">
     <div className="bg-white p-4 -mt-1 -ms-2 rounded-lg shadow-md">
       ...
       <div>
           <label className="block mb-2 font-normal text-[#303F58] text-[14px]">Journal Number</label>
           <input
             type="text"
             name="orderNumber"
       ...
       <div className="grid grid-cols-2 gap-4 mb-4">
       <div>
           <label className="block mb-2 font-normal text-[#303F58] text-[14px]">Reference Number</label>
           <input
             type="text"
             name="orderNumber"
             className="w-full p-2 border rounded-md  text-[#8F99A9] text-[14px] font-normal"
...
<div className="flex w-[30%] h-[250px] p-6 rounded-lg shadow-md mt-14 bg-white">
