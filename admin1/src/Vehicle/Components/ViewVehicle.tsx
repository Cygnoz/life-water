  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="bg-[#FFFFFD] shadow-md rounded-[8px] p-[8px_16px] flex justify-center items-center gap-[6px] mb-6 mx-20 w-[1145px] h-[52px]">
        ...
        <button
          className={`flex-3 flex items-center justify-center py-2 rounded-md font-medium space-x-2 px-6 ${activeTab === 'information' ? 'bg-gray-200' : 'hover:bg-gray-200'}`}
        ...
        <button
          className={`flex-1 flex items-center justify-start py-2 rounded-md font-medium space-x-2 px-6 ${activeTab === 'rideHistory' ? 'bg-gray-200' : 'hover:bg-gray-200'}`}
      ...
      {activeTab === 'information' ? (
        ...
        <div className="bg-white shadow-md rounded-lg p-6 mx-4">
          ...
          {/* <h2 className="text-2xl font-bold text-gray-700 mb-6">Ride History</h2> */}
