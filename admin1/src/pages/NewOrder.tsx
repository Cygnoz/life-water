          ...
          {filteredCustomers.map((customer) => (
            ...
            >
              ...
              <div className="col-span-10 flex">
                <div>
                  <p className="font-semibold text-[14px] text-[#0B1320]"> {customer.firstName} {customer.lastName}</p>
      ...
      <div ref={dropdownRef} className="absolute z-10 bg-white rounded-md mt-1 p-2 w-[326px] h-auto space-y-1">
        ...
        {filteredStaffList.map((staff, index) => (
          ...
          >
            <div className="col-span-2 flex items-center justify-center">
              <img
                src={staff.profile ? `${BASEURL}/uploads/${staff.profile}` : defaultImage}
                alt={`${staff.firstname} ${staff.lastname}`}
              />
            </div>
            <div className="col-span-10 flex">
              <div>
                <p className="font-semibold text-[14px] text-[#0B1320]">{staff.firstname} {staff.lastname}</p>
