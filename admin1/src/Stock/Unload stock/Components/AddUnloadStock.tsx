...
<div className="max-h-screen w-[70%]">
 ...
 <div className="flex gap-3 items-center w-full max-w-8xl ms-1 mt-2">
  ...
  <h3 className="text-[20px] text-[#303F58] font-bold ms-1">Add Unload Stock</h3>
</div>
   <div className="container mx-auto p-4">
     <div className="bg-white p-4 -mt-1 -ms-2 rounded-lg shadow-md">
       ...
       <div className="grid grid-cols-2 gap-4 mb-4">
         <div>
           <label className="block mb-2 font-[400px] text-[#303F58] text-[14px]">Main Route</label>
           <select
             name="customer"
         ...
         <div>
           <label className="block mb-2 font-[400px] text-[#303F58] text-[14px]">Category</label>
           <select
             name="customer"
             value={orderDetails.customer}
             onChange={updateOrder}
       ...
       <div className="grid grid-cols-2 gap-4 mb-4">
       <div>
           <label className="block mb-2 font-[400px] text-[#303F58] text-[14px]">Date</label>
           <input
             type="date"
             name="date"
         ...
         <div>
           <label className="block mb-2 font-[400px] text-[#303F58] text-[14px]">Transfer Number</label>
           <input
             type="text"
             name="orderNumber"
             className="w-full p-2 border rounded-md  text-[#8F99A9] text-[14px] font-normal"
...
<table className="w-full text-left">
       ...
       <div className="mb-4">
         <label className="block mb-2 font-[400px] text-[#303F58] text-[14px]">Terms & Conditions</label>
         <textarea
           name="terms"
