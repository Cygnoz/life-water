        ...
        <div className="max-h-screen w-[70%]">
         ...
         <div className="flex-1 min-h-screen">
           <div className="container mx-auto p-1">
             <h1 className="text-[20px] font-semibold mb-6 text-[#303F58]">Add W-Stock</h1>
  
             <div className="bg-white p-3 -mt-4 rounded-lg shadow-md">
               {/* Customer and Salesman Selection */}
               <div className="grid grid-cols-2 gap-4 mb-4">
                 <div>
                   <label className="block mb-2 font-medium text-[#303F58] text-[14px]">Warehouse</label>
                   <select
                     name="customer"
                 ...
                 <div>
                   <label className="block mb-2 font-medium text-[#303F58] text-[14px]">Date</label>
                   <input
                     type="date"
                     name="date"
  ...
  <table className="w-full text-left">
                <thead className=' bg-[#fdf8f0]'>
                  <tr className="border-b">
                    <th className="p-2 text-center">Item Details</th>
                ...
                <tbody>
                  <tr className="border-b">
                    <td className="p-2 text-center">
                      <label className='text-[#8F99A9] item-center text-[14px]'>Type or Click</label>
                      <select name="" id="" className='text-gray-400'>
                        <option value=""></option>
                      </select>
                    </td>
                    <td className="p-2 text-[#8F99A9] text-center text-[14px]">0</td>
                  
                    <td className="p-2 text-[#8F99A9] text-center text-[14px]">0.00</td>
                    <td className="p-2 text-center">
