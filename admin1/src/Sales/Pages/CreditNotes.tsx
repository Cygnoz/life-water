...
<div className="flex justify-between items-center  pt-3 mx-4">
        <div >
          <h3 className="text-[#303F58] text-[20px]  font-bold">Credit Notes</h3>
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                <tr className="border-b">
                  ...
                  <td className="p-2 text-[14] text-center text-[#4B5C79]">max 2 free</td>
                ...
                <tr className="border-b">
                  ...
                  <td className="p-2 text-[14] text-center text-[#4B5C79]">min 3 free</td>
