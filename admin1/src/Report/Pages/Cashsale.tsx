...
<div>
    ...
    <div className="flex justify-between items-center my-2 mx-2">
      <div>
        <h3 className="text-[#303F58] text-[20px] font-bold">Cash Sale</h3>
...
<div className="bg-white shadow-md rounded-lg p-4">
          <div className="flex justify-between items-center mb-4">
              ...
              <input
                ...
                placeholder="Search Coupon Sale"
            ...
            <table className="w-[785] text-left">
              <thead className=' bg-[#fdf8f0]'>
                <tr className="border-b">
                  <th className="p-2 text-[12px] w-[225px] text-center text-[#303F58]">Sales Man</th>
                  <th className="p-2 text-[12px] text-center w-[530px] text-[#303F58]"></th>
              ...
              <tbody>
                <tr className="border-b">
                  <td className="p-2 text-[14] text-center w-[225px] text-[#4B5C79]">Total Quantity</td>
                  <td className="p-2 text-[14] bg-[#fdf8f0] text-center w-[530px] text-[#4B5C79]">89</td>
                 
                </tr>
                <tr className="border-b">
                  <td className="p-2 text-[14] text-center text-[#4B5C79]">Total Acount</td>
                  <td className="p-2 text-[14] text-center bg-[#fdf8f0]   text-[#4B5C79]">89</td>
