      ...
      <div className="w-[76px] h-[1080px] pt-[50px] pb-[134px] bg-[#820000] flex-col justify-start items-center inline-flex">
        <div className="h-[860px] flex-col justify-center items-center gap-2 inline-flex">
          ...
          {[
            ...
            <div key={index} className="self-stretch h-[54px] flex-col justify-start items-center gap-1.5 flex hover:bg-[#530015] rounded-lg p-2 cursor-pointer transition-all duration-200 ease-in-out">
              <div className="w-[42px] h-9 px-2.5 rounded-lg flex-col justify-center items-center gap-2 flex">
                <div className="justify-start items-center gap-2 inline-flex">
                  <img src={item.src} alt={item.label} />
                </div>
              </div>
              <div className="self-stretch text-center text-[#f7e7ce] text-[10px] font-semibold ">{item.label}</div>
            </div>
          ))}
        </div>
      </div>
